...
ap.add_argument('centerVideo', type=str, nargs="?", default="", \
    help="2nd: Recorded video file from center camera")
args = ap.parse_args()
picklePath = args.picklePath
centerVideo = args.centerVideo
...
dataList, fps, fwidth = dataLoad[0],dataLoad[1],dataLoad[2]
sliceWidth, sliceHeight, t_ = dataLoad[3],dataLoad[4],dataLoad[5]
stamp, setupTime, recordTime = dataLoad[6],dataLoad[7],dataLoad[8]
recordFrames, record_fps = dataLoad[9],dataLoad[10]
...
cap1 = cv2.VideoCapture(centerVideo) # (sliceWidth, sliceHeight) values from Recording stage, lines 20, 24
balanceProcess = '/home/pi/process/balanceProcessed/'+ stamp + ' balanceProcess.avi'
balanceFig = '/home/pi/process/balanceProcessed/'+ stamp + ' balanceTest.png'
...
while 1:    
    ...
    if faceFound == False:
        ...
        template = cv2.imread('/home/pi/md4/images/33-0.png',0) # 13-0.png
...
# plt.text(-0.3, 40.9, 'Time = {:.3f} s'.format(elapsedTime))
...
picklePath2 = '/home/pi/pickle/balance' + stamp + '.pkl'
# os.mkdir(picklePath2)
